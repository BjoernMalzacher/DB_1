...
public class JDBCBikeShop {
    public static void main(String[] args) {
        try {
            new JDBCBikeShop().createConnection("admin", "admin", "db_1-postgres-1", 5432, "", "");
        } catch (SQLException e) {
          System.out.println("didn't work");
            e.printStackTrace();
        }
    }
    public void createConnection(String user,String pw, String server, int port, String db, String scheme  ) throws SQLException{
        try {
